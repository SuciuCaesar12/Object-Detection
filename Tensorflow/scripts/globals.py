...
PATHS = {
    ...
    'API_MODEL': os.path.join('..', '..', 'model'),
    'DATASET_PATH': os.path.join('../../dataset'),
    'MODEL_PATH': os.path.join('..', 'workspace', 'model'),
    'PRETRAINED_MODEL_PATH': os.path.join('..', 'workspace', 'pre_trained_model'),
    'CHECKPOINT_PATH': os.path.join('..', 'workspace', 'model', CUSTOM_MODEL_NAME),
    'OUTPUT_PATH': os.path.join('..', 'workspace', 'model', CUSTOM_MODEL_NAME, 'export')
}

FILES = {
    'LABELMAP': os.path.join(PATHS['ANNOTATION_PATH'], LABEL_MAP_NAME),
    'PIPELINE_CONFIG': os.path.join('..', 'workspace', 'model', CUSTOM_MODEL_NAME, 'pipeline.config')
}
