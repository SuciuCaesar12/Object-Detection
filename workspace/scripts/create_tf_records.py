...
HEIGHT, WIDTH, IMAGE_FORMAT = 960, 1280, b'jpeg'
...
def get_examples_info(split):
    ...
    for dataset_name in DATASET_NAMES:
        ...
        examples.extend(loader.load_examples(path_dataset=os.path.join(PATHS['DATASET_PATH'], dataset_name),
                                             split=split))
...
if __name__ == '__main__':
    ...
    img_paths, labels, bb_cords = split_examples(examples[:100])
